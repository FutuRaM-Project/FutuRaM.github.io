...
![Figure 2.1: Development process](figures/fig_method.png)

##### Figure 2.1: Scenario storyline development process <!-- omit in toc -->
...
![Alt text](figures/fig_241.png)  

##### Figure 2.4.1: Process of identifying key elements for the storylines and scenarios <!-- omit in toc -->
...
2. **Screening:**  
  ...
  ##### Figure 2.4.2: Part of the screening process for elements to be included in the FutuRaM scenarios <!-- omit in toc -->
